...
class Graph:
    ...
    def compute_loops(self, n, genus):
        ...
        keys = list(self.nodes_to_faces.keys())
        ...
        for face in fourgons:
            for node in face:
                ...
                keys = list(self.nodes_to_faces.keys())
        self.nodes_to_faces = {int(k): tuple(v) for k,v in six.iteritems(self.nodes_to_faces)}
        nodes = list(range(n))
            ...
            # Trial: remove all duplicates
                ...
                for face in non_fourgons:
                    ...
                    for i in range(temp_len):
                        ...
                        for triple in (temp_path[i:i+3] for i in range(temp_len-2)):
