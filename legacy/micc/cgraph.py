...
def cdfs(current_node, start_node, graph, current_path, nodes_to_face):
    try:
        from . import _micc_dfs
    except (ImportError, ValueError):
        import _micc_dfs
    
    # Match the argument order of the native module: (current_node, start_node, current_path, graph, nodes_to_faces)
    return _micc_dfs.cdfs(current_node, start_node, current_path, graph, nodes_to_face)
